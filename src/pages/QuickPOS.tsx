...
export default function QuickPOS() {
  ...
  return (
    <div className="w-screen h-screen min-h-screen flex flex-col bg-gray-50 overflow-hidden">
        ...
        <div className="w-96 bg-white border-l flex flex-col h-full flex-shrink-0 min-h-0">
          ...
          <div className="p-4 border-t space-y-2">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <label className="flex items-center gap-1 cursor-pointer">
                <input type="radio" checked={paymentMethod === 'wallet'} onChange={() => setPaymentMethod('wallet')} /> Mobile Wallet
              </label>
            </div>
            <button className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded text-lg mt-2" onClick={handleGenerateBill}>Generate Bill</button>
              </div>
              </div>
            </div>
      ...
      {isPaymentDialogOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 w-full max-w-2xl shadow-lg relative flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1 min-w-[260px]">
              ...
              <div className="mb-4">
                <label className="block text-gray-700 font-semibold mb-1">Bill Amount</label>
                <input type="text" className="border rounded px-3 py-2 w-full bg-gray-100" value={`₹${cart.getTotal().toFixed(2)}`} readOnly />
              </div>
              {paymentMethod === 'cash' && (
                <>
                  <div className="mb-4">
                    <label className="block text-gray-700 font-semibold mb-1">Tendered <span className="text-red-600">*</span></label>
                    <input
                      type="text"
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-700 font-semibold mb-1">Change Due</label>
                    <input type="text" className="border rounded px-3 py-2 w-full bg-gray-100 text-right" value={`₹${Math.max(0, (parseFloat(cashAmount) || 0) - cart.getTotal()).toFixed(2)}`} readOnly />
            ...
            {paymentMethod === 'card' && (
                <>
                  <div className="mb-4">
                    <label className="block text-gray-700 font-semibold mb-1">Amount <span className="text-red-600">*</span></label>
                    <input
                      type="text"
                      className="border rounded px-3 py-2 w-full text-right text-lg"
                      value={cashAmount}
                  ...
                  <div className="mb-4">
                    <label className="block text-gray-700 font-semibold mb-1">Txn. ID</label>
                    <input
                      type="text"
              ...
              <div className="flex gap-4 mt-6">
                <button className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 rounded" onClick={() => setIsPaymentDialogOpen(false)}>Cancel</button>
                <button className="flex-1 bg-blue-700 hover:bg-blue-800 text-white font-bold py-2 rounded flex items-center justify-center gap-2" onClick={() => { handleTransactionComplete(); setIsPaymentDialogOpen(false); }}>
            ...
            <div className="flex flex-col gap-2 items-center justify-center">
              <div className="grid grid-cols-4 gap-2 mb-2">
                {[2000, 500, 200, 100, 1,2,3,4,5,6,7,8,9,0,'.','CLR'].map((key, idx) => (
                  <button
                    key={idx}
                    className={`bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded text-lg ${key==='CLR' ? 'col-span-2 bg-red-600 hover:bg-red-700' : ''}`}
